...
1. In your Connected logistics application page, from the left-hand menu navigate to **Devices** and in the **All devices** tab copy the **Device ID** of **SN 100** device. Save the value locally in the text file, you will use these values in the later part of the lab.
