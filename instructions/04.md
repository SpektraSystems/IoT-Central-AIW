...
1. In the Telemetry drop-down select **Temp**, in the **Aggregation** drop-down	 select **Average**. Next, choose **Is greater than or equal to**  as the **Operator** and enter 14 as the Value.
