...
1. In the **Job properties** section, under **Job type**, select **Command** from the drop down. Then under command, select **Update Firmware** and click on **Next** to go to **Delivery Options** page.
