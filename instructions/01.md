...
1. By default, the rule automatically applies to all the devices associated with the device template. You can use the **Filter** option to further refine what devices should be included, filters use properties on the device template to filter down the set of devices. For now, you can leave it as default.
