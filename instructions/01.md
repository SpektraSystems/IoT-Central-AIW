...
In this exercise, you have learned how to create an application from IoT Central, and explored through your application dashboard. You also learned to add the new device's in the application, created rules, configured jobs, and analyzed telemetry data.
