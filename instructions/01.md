...
1. In the **Job properties** section, under **Job type**, select **Command** from the drop down. Then select **Update Firmware** under command and click on **Next** to go to **Delivery Options** page.
