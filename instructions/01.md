...
1. Now navigate to the **Raw data** tab, from here you can view the raw data that a device sends to an application. This view is useful for troubleshooting issues with the payload sent from a device.
      
1. In the **Raw data** tab, expand the latest **Timestamp** and verify the Status is **Offline**.
